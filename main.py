...
from fi.opt import setup_logging
...
def main() -> None:
    ...
    generator = LiteLLMGenerator(model="gpt-4o-mini", prompt_template="{prompt}")
    ...
    optimizer = PromptWizardOptimizer(teacher_generator=generator, beam_size=2)

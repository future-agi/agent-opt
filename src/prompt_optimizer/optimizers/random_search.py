...
class RandomSearchOptimizer(BaseOptimizer):
    ...
    def _generate_variations(self, initial_prompt: str) -> List[str]:
        ...
        try:
            ...
            # logging.info(f"Teacher model response:\n{response_content}")
            ...
            logging.error(f"Failed to parse teacher model response: {e}")
        except Exception as e:
            logging.error(f"An error occurred with the teacher model: {e}")

        logging.error(f"Problematic response content was: {response_content}")
